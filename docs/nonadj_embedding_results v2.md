...
## Update: Full 4-Level Verification (K₆, K₈, K₁₀, K₁₂)

All 6 level pairs tested. Every result confirmed:

| Embedding  | Skip | Pairings | Rank-1 | Spectra | Xrank | NatRank |
|------------|------|----------|--------|---------|-------|---------|
| K₆→K₈     | 0    | 1        | 1/1    | 1       | 10    | 10      |
| K₆→K₁₀    | 1    | 3        | 3/3    | 1       | 10    | 10      |
| K₆→K₁₂    | 2    | 15       | 15/15  | 1       | 10    | 10      |
| K₈→K₁₀    | 0    | 1        | 1/1    | 1       | 21    | 21      |
| K₈→K₁₂    | 1    | 3        | 3/3    | 1       | 21    | 21      |
| K₁₀→K₁₂   | 0    | 1        | 1/1    | 1       | 36    | 36      |

**The cross-coupling rank is an intrinsic invariant of the source level.**

K₈→K₁₂ confirmed: rank = 21 regardless of pairing. The coupling capacity of K₈ is exactly its native overlap rank (21 = half of 42 vacuum matchings), whether embedded in K₁₀ or K₁₂.

Cross-coupling SV equivalence classes for 3-pairing cases:
- K₆→K₁₀: {0,2}, {1} — 2 classes (same symmetry as vertex swap within pairs)
- K₈→K₁₂: {0,2}, {1} — identical structure
- K₆→K₁₂: 9 classes from 15 pairings — richer symmetry breaking

Code integrated into `coupling_probe_unified.py` as `embedding_analysis()`, activated with `--no-embedding` to skip.
